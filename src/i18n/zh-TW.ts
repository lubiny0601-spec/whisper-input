...
export const zhTW: typeof zhCN = {
  ...
  onboarding: {
    ...
    steps: {
      ...
      llm: {
        title: 'LLM 潤色',
        body: '配置 AI 潤色模型，預設推薦千問 Flash（qwen3.5-flash）；需要更強生成時可切換 Gemini 2.5 Flash 或 Flash-Lite。',
        geminiNotice: '預設推薦千問 Flash（qwen3.5-flash）；可按需要選擇 Gemini 2.5 Flash 或 Flash-Lite。',
        configure: '配置潤色模型',
      },
      hotkey: {
        title: '快捷鍵和測試',
  ...
  settings: {
    ...
    privacy: {
      ...
      clearConfigBtn: '清空配置',
      exportDiagnosticsLabel: '匯出診斷包',
      exportDiagnosticsDesc: '匯出最近 200 條診斷 trace、歷史摘要和日誌尾部。API Key、token 和 secret 會脫敏。',
      exportDiagnosticsBtn: '匯出診斷包',
      diagnosticExportDone: '診斷包已匯出',
    ...
    providers: {
      ...
      presets: {
        ...
        openai: 'OpenAI',
        gemini: 'Gemini',
        qwenMax: '千問 Flash · qwen3.5-flash',
